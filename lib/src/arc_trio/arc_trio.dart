...
class ArcTrio extends StatefulWidget {
  final double size;
  final Color color;

  const ArcTrio({super.key, required this.color, required this.size});

  @override
  State<ArcTrio> createState() => _ArcTrioState();
}

class _ArcTrioState extends State<ArcTrio> with SingleTickerProviderStateMixin {
