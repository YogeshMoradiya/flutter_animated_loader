...
class TriangularDot extends StatefulWidget {
  final double size;
  final Color color;

  const TriangularDot({super.key, required this.size, required this.color});

  @override
  TriangularDotState createState() => TriangularDotState();
}

class TriangularDotState extends State<TriangularDot>
