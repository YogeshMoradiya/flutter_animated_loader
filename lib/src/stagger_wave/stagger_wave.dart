...
class StaggerWave extends StatefulWidget {
  final double size;
  final Color color;

  const StaggerWave({super.key, required this.size, required this.color});

  @override
  State<StaggerWave> createState() => _StaggerWaveState();
}

class _StaggerWaveState extends State<StaggerWave>
