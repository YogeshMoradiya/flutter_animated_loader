...
class HorizontalSpin extends StatefulWidget {
  final double size;
  final Color color;

  const HorizontalSpin({super.key, required this.size, required this.color});

  @override
  HorizontalSpinState createState() => HorizontalSpinState();
}

class HorizontalSpinState extends State<HorizontalSpin>
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _animationController, curve: _interval));
