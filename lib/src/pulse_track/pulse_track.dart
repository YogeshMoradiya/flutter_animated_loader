...
class PulseTrack extends StatefulWidget {
  final double size;
  final Color color;

  const PulseTrack({super.key, required this.color, required this.size});

  @override
  PulseTrackState createState() => PulseTrackState();
}

class PulseTrackState extends State<PulseTrack>
