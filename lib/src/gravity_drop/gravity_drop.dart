...
class GravityDrop extends StatefulWidget {
  ...
  const GravityDrop({super.key, required this.color, required this.size});

  @override
  GravityDropState createState() => GravityDropState();
}

class GravityDropState extends State<GravityDrop>
