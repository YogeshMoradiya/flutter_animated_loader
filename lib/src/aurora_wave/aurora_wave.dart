...
class AuroraWave extends StatefulWidget {
  ...
  const AuroraWave({super.key, required this.size, required this.color});

  @override
  AuroraWaveState createState() => AuroraWaveState();
}

class AuroraWaveState extends State<AuroraWave>
