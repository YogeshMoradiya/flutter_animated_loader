...
class QuadSpin extends StatefulWidget {
  final double size;
  final Color color;

  const QuadSpin({super.key, required this.color, required this.size});

  @override
  QuadSpinState createState() => QuadSpinState();
}

class QuadSpinState extends State<QuadSpin>
