...
class BounceBall extends StatefulWidget {
  ...
  const BounceBall({super.key, required this.size, required this.color});

  @override
  BounceBallState createState() => BounceBallState();
}

class BounceBallState extends State<BounceBall>
              ...
              Visibility(
                ...
                child: Transform.translate(
                  ...
                  child: Align(
                    ...
                    child: DrawDot.circular(color: color, dotSize: ballSize),
                  ),
                ),
              ),
              Visibility(
