...
class TriangleOrbit extends StatefulWidget {
  final double size;
  final Color color;
  const TriangleOrbit({super.key, required this.color, required this.size});

  @override
  TriangleOrbitState createState() => TriangleOrbitState();
}

class TriangleOrbitState extends State<TriangleOrbit>
